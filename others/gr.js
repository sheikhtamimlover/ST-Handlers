...
module.exports = {
  ...
  ST: async function ({ message, args, event }) {
    ...
    if (args[0] === "🫴" || args[0] === "😵‍💫" || args[0] === "commands") {
      ...
      guideMsg += `• growth on/off - en/of system\n`;
      ...
      guideMsg += `• growth h/☣️ clear - Clear all\n`;
      guideMsg += `• growth h/☣️ clear <num1> <num2>... - Clear specific\n\n`;
      
      guideMsg += `💡 EXAMPLES:\n`;
      guideMsg += `• growth (⚠️ t/⤴️ 500\n`;
      guideMsg += `• growth a/+ u/⬆️ 100\n`;
      guideMsg += `• growth -/⬇️ thread 50\n`;
      guideMsg += `• growth i/🕛 3\n`;
      guideMsg += `• growth h/☣️ 20\n`;
      guideMsg += `• growth h/☣️ clear 1 5 10`;
