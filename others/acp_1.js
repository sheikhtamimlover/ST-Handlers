...
module.exports = {
  config: {
    ...
    countDown: 8,
    role: 0,
    description: "Accept or list friend requests",
    category: "Utility",
    guide: {
      en: "{pn} - Accept your own friend request\n{pn} -l - List all pending requests (admin only)"
    }
  },
  ...
  ST: async function ({ event, api, args, commandName }) {
