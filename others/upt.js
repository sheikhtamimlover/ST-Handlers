...
module.exports = {
  ...
  ST: async function({ message, api, threadsData, usersData }) {
    try {
      ...
      try {
        ...
        console.log("Could not fetch thread/user data:", err);
      }
...
└─ Active Sessions: ${global.GoatBot?.onReply?.size || 0}
