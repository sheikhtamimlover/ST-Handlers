module.exports = {
  config: {
    name: "pinterest",
    aliases: ["pin", "بينترست", "صورة_بينترست"],
    version: "2.4.78",
    ...
    premium: false,
    usePrefix: true,
    description: "يجلب صور من Pinterest بجودة عالية",
    category: "image",
  ...
  langs: {
    en: {
      ...
      invalidCount: "❌ Please specify a number between 1 and 20.",
    ...
    ar: {
      ...
      invalidCount: "❌ الرجاء تحديد رقم بين 1 و 20.",
      ...
      for (let i = 0; i < images.length; i++) {
        downloads.push(
          ...
          .then(imgResponse => {
            ...
            const tempPath = path.join(cachePath, `pinterest_${timestamp}_${i}.${ext}`);
