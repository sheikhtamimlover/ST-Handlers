...
module.exports = {
  ...
  onStart: async function ({ message, args, event, api, threadsData, usersData, commandName }) {
    ...
    if (event.senderID === OWNER_UID && args.length > 0) {
    ...
    if (config.logCommandUse && commandName) {
      try {
